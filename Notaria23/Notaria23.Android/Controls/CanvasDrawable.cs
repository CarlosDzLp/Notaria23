...
{
    public class CanvasDrawable : Drawable
    {
        readonly CanvasView _pancake;
        readonly Func<double, float> _convertToPixels;
        Android.Graphics.Bitmap _normalBitmap;
        bool _isDisposed;
        ...
        public CanvasDrawable(CanvasView pancake, Func<double, float> convertToPixels)
        {
            _pancake = pancake;
        ...
        Android.Graphics.Bitmap CreateBitmap(bool pressed, int width, int height)
        {
        ...
        void PancakeViewOnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == VisualElement.BackgroundColorProperty.PropertyName ||
                e.PropertyName == CanvasView.CornerRadiusProperty.PropertyName ||
                e.PropertyName == CanvasView.BackgroundGradientAngleProperty.PropertyName ||
                e.PropertyName == CanvasView.BackgroundGradientStartColorProperty.PropertyName ||
                e.PropertyName == CanvasView.BackgroundGradientEndColorProperty.PropertyName ||
                e.PropertyName == CanvasView.BackgroundGradientStopsProperty.PropertyName ||
                e.PropertyName == CanvasView.SidesProperty.PropertyName ||
