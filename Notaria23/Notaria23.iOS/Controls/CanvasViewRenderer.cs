...
{
    public class CanvasViewRenderer : ViewRenderer<CanvasView, UIView>
    {
...
#pragma warning restore 0219
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<CanvasView> e)
        {
            ...
            {
                Validate(Element as CanvasView);
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            else if ((e.PropertyName == CanvasView.BorderColorProperty.PropertyName) ||
            ...
            else if ((e.PropertyName == CanvasView.BackgroundGradientStartColorProperty.PropertyName) ||
        ...
        private void SetCornerRadius()
        {
            if (Element == null)
                return;
            var elementCornerRadius = (Element as CanvasView).CornerRadius;
